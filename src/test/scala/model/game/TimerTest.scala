...
class TimerTest extends AnyWordSpec with Matchers:
  ...
  "TimerLogic" when:
    ...
    "checking triggers" should:
      val trigger6 = Trigger(6.seconds, () => println("6 seconds remaining!"))
      val trigger5 = Trigger(5.seconds, () => println("5 seconds remaining!"))
      val trigger3 = Trigger(3.seconds, () => println("3 seconds remaining!"))
