  ...
  "ResponseParser" when:
    ...
    "parsing case files" should :
      ...
      "extract multiple case files" in :
        ...
        caseFiles.map(_.title) should contain allOf("Threatening Email", "Note")
    ...
    "parsing malformed JSON" should :
      ...
      "reject JSON with missing required fields" in :
        ...
        val result = ResponseParser.given_ResponseParser_Case.parse(incompleteJson)
      ...
      "reject JSON with wrong field types" in :
        ...
        val result = ResponseParser.given_ResponseParser_Case.parse(wrongTypeJson)
