...
|:--------:|:--------------------:|:----------------------------------------------|:-----------------:|:--------------------------:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
|    1     |      Versioning      | Logic Implementation - Refactor (#29)         | Lucia Castellucci |             5              | 3 | 2 | - | - | - | - | - |
|    1     |   Case generation    | Controller (#12)                              |  Roberto Mitugno  |             3              | 3 | - | - | - | - | - | - |
|    1     | Trigger/In-game hint | Logic Design and Documentation (#24) - Finish |    Luca Samorè    |             12             | 2 | 1 | - | - | - | - | - |
|    1     | Trigger/In-game hint | Logic Implementation (TDD loop) (#26)         |    Luca Samorè    |             6              | - | - | - | 4 | - | - | - |
|    1     | Trigger/In-game hint | Controller Design and Implementation (#25)    |    Luca Samorè    |             4              | - | - | - | - | - | 1 | 2 |
|    1     | Trigger/In-game hint | Test and Final Deploy (#27)                   |    Luca Samorè    |             2              | - | - | - | - | - | - | 1 |
|    2     |      Versioning      | Controller Design & Implementation (#30)      | Lucia Castellucci |             2              | - | 2 | - | - | - | - | - |
|    2     |   Knowledge Graph    | Controller (#19)                              |  Roberto Mitugno  |             4              | - | 3 | 3 | - | - | - | - |
|    2     |        Timer         | Controller (#65)                              |  Roberto Mitugno  |             3              | - | - | - | - | - | - | - |
|    3     |       Solution       | Logic Design (#28)                            | Lucia Castellucci |             1              | - | - | 1 | - | - | - | 3 |
|    3     |       Solution       | Logic Minimal Implementation (#29)            | Lucia Castellucci |             1              | - | - | 1 | - | - | - | - |
|    3     |       Solution       | Controller Design and Implementation (#30)    | Lucia Castellucci |             1              | - | - | - | 1 | - | - | - |
