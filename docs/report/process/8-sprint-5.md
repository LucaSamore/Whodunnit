...
## Goal
The primary goal of this sprint is to focus on implementing the core game functionalities, particularly solution management and completing the main GUI. Work will also proceed on completing case generation and knowledge graph management.
...
|    2     |           Timer            | Controller (#65)                              |  Roberto Mitugno  |             3              | - | - | 3 | - | - | - | - |
|    3     |       FR5 - Solution       | Logic Design (#28)                            | Lucia Castellucci |             1              | - | - | 1 | - | - | - | - |
