...
|:--------:|:------------------------:|:-------------------------------------------------|:-----------------:|:--------------------------:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
|    1     |  FR1 - Case Generation   | Test and Implementation (TDD loop) (#14) - Start |  Roberto Mitugno  |             14             | - | 3 | - | 3 | - | - | 3 |
|    1     |  FR1 - Case Generation   | Logic Design and Documentation (#13)             |    Luca Samorè    |             6              | - | - | 4 | 2 | - | - | - |
|    1     |  FR2 - Knowledge Graph   | Logic Design and Documentation (#16)             |    Luca Samorè    |             6              | - | - | 2 | 3 | 1 | - | - |
